...
import { Shield, Wallet, Activity, Zap, Database, FileText, Settings } from 'lucide-react';
...
const menuItems = [
  { id: 'policies', icon: Shield, label: 'My Policies', color: 'cyan' },
  { id: 'purchase', icon: Wallet, label: 'Buy Coverage', color: 'emerald' },
  { id: 'ai-swarm', icon: Activity, label: 'AI Swarm', color: 'purple' },
  { id: 'treasury', icon: Database, label: 'Treasury', color: 'blue' },
  { id: 'analytics', icon: Zap, label: 'Analytics', color: 'amber' },
  { id: 'claims', icon: FileText, label: 'Claims History', color: 'rose' },
];
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute left-full ml-4 px-3 py-2 bg-slate-900/95 backdrop-blur-sm border border-cyan-500/30 rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-200 whitespace-nowrap z-50">
